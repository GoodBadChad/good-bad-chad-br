...
class GameEngine {
    ...
    /** 
     * This method is going to rotate an image around a point.
     * @param {Image} image The image that you want to rotate.
     * @param {number} x The x coordinate of the point around which you want to rotate the image.
     * @param {number} y The y coordinate of the point around which you want to rotate the image.
     * @param {number} angle The angle, in radians, by which you want to rotate the image.
     */
    rotateImage(image, x, y, angle) {
        CTX.save();
        CTX.translate(x, y);
        CTX.rotate(angle);
