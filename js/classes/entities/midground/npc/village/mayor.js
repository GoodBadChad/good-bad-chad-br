...
class Mayor {
     ...
     * @param {Conversation} convo The conversation that will show if Mayor is interacted with.
     */
    constructor(pos, convo = null) {
        /** The position of the Papa Chad (in the game world). */
        this.pos = pos;
        /** The velocity at which Mayor is moving. */
        ...
        this.boundingBox = new BoundingBox(this.pos, Mayor.SCALED_SIZE);
    ...
    static get SCALED_SIZE() {
        return Vector.multiply(Mayor.SIZE, Mayor.SCALE);
    }

    /** The filepath to Papa Chad's spritesheet. */
    static get SPRITESHEET() {
        return "./sprites/mayor.png";
    };
                ...
                if (this.boundingBox.collide(entity.boundingBox)) {
                    if (entity instanceof Block) {
                        ...
                        if (isOverlapX
                            ...
                            this.pos = new Vector(this.pos.x, entity.boundingBox.top - Mayor.SCALED_SIZE.y);
                            ...
                            this.pos = new Vector(entity.boundingBox.left - Mayor.SCALED_SIZE.x, this.pos.y);
                        } else if (isOverlapY
    ...
    draw() {
        this.animations[this.facing][this.action].drawFrame(Vector.worldToCanvasSpace(this.pos), Mayor.SCALE);
        if (this.conversation.new) {
            const indicator = new OverheadIcon(this, Mayor.SCALED_SIZE.x, OverheadIcon.TRIANGLE, OverheadIcon.GREEN);
            indicator.draw();
        }
    };
